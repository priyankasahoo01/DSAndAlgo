...
class Solution {
    ...
    static class BinarySearchTree {
        ...
        public int find(Node node, int num) {
            if (root == null) {
                return -1;
            }
            if (isLeaf(node)) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 6; i < 27; i++) {
            int result = bst.findLargestSmallerKey(i);
            System.out.println("Largest smaller number " + i + " --> " + result);
        }
